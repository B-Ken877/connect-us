...
import { demarrerEntretien, enregistrerReponse, soumettreEntretien, abandonnerEntretien } from "@/server/services/interview-service";
 ...
 * Returns the created (or resumed) call attempt with respondent context.
 */
  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        tentative: attribution.appel?.attemptNumber ?? 1,
      },
    };
  } catch (e) {
    return erreur(e);
